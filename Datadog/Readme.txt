...
creating and running via helm chart
pre-requisite:
docker-dekstop should be running

cd frontend (for each service)
helm create helm-chart
edit the required files as per services
helm lint helm-chart

cd Microservice (for each service)
helm install frontend .\frontend\helm-chart\

kubectl get pods
kubectl get svc
kubectl port-forward service/frontend-helm-chart 5000:5000
...
***Docker Hub***
docker tag datadog-frontend-svc:latest jyotsnavish/datadog-apm:frontend-app
docker tag datadog-user-svc:latest jyotsnavish/datadog-apm:user-app
docker tag datadog-order-svc:latest jyotsnavish/datadog-apm:order-app
docker tag datadog-book-svc:latest jyotsnavish/datadog-apm:book-app

docker push jyotsnavish/datadog-apm:frontend-app
docker push jyotsnavish/datadog-apm:book-app
docker push jyotsnavish/datadog-apm:user-app
docker push jyotsnavish/datadog-apm:order-app
